/*
    회원 정보를 입력받아 userList에 user객체들을 가입하기 번튼을 누를 때마다 저장한다.
    로그인 정보를 입력받아 userList에 해당 username이 있는지 확인하고 없으면 '사용자 정보를 다시 확인하세요.' 메시지를 출력(alert)
    있으면 비밀번호가 일치하는지 검사 후 비밀번호가 일치하지 않으면 '사용자 정보를 다시 확인하세요.' 메시지 출력(alert)
